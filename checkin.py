    ...
    def punch_in(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"[+] Check-in response: {json.dumps(punch_response, indent=2)}")
                
                if 'msg' in punch_response and 'punchIn' in punch_response['msg']:
                    print(f"[+] Check-in successful at {punch_response['msg']['punchIn']}")
                    return True
                elif 'msg' in punch_response:
